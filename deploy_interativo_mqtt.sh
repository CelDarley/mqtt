...
# Script de Deploy da API MQTT Laravel no servidor MQTT (Interativo)
...
echo "⚠️ Será necessário digitar a senha sudo quando solicitado..."

# Criar pastas uma por uma para evitar problemas
executar_mqtt "sudo mkdir -p $PASTA_DESTINO"
echo "✅ Pasta principal criada"

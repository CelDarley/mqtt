...
# Script de Deploy Final Corrigido da API MQTT Laravel
# Para executar como ROOT no servidor: 10.100.0.200
# Copie este arquivo para /root/ na máquina 10.100.0.200 e execute: sudo ./deploy_servidor_200_final_corrigido.sh

set -e

echo "🚀 Iniciando deploy final corrigido da API MQTT Laravel..."
...
if [ "$EUID" -ne 0 ]; then
    ...
    echo "Execute: sudo ./deploy_servidor_200_final_corrigido.sh"
    exit 1
fi
...
echo "🔧 Configurando permissões de forma completa..."

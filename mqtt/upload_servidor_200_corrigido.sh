...
if ! ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=no "$USUARIO_DESTINO@$SERVIDOR_DESTINO" "echo 'Conexão OK'"; then
...
ssh -o StrictHostKeyChecking=no "$USUARIO_DESTINO@$SERVIDOR_DESTINO" "mkdir -p $PASTA_TEMP"
